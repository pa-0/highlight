...
19.08.2024
 ...
 - fixed SWIG lib compilation (https://gitlab.com/saalen/highlight/-/issues/247)
 - updated Terraform file suffix list (https://gitlab.com/saalen/highlight/-/issues/250)
