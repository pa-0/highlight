...
07.05.2024
 ...
 - updated astyle lib to version 3.4.15
 - Remove `using namespace std;` in header files (merge request saalen/highlight!147)
 - added `-webkit-user-select` to line number style (https://gitlab.com/saalen/highlight/-/issues/214)
