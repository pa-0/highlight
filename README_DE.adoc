...
BlockComment   = Attributes (Blockkommentaren)

LineComment    = Attributes (Zeilenkommentaren)

LineNum        = Attributes (Zeilennummern)

Operator       = Attributes (Operatoren)

Hover          = Attibutes (LSP Hover Elementen)

Error          = Attibutes (LSP Syntaxfehler)

ErrorMessage   = Attibutes (LSP Fehlerbeschreibungen)
...
SemanticTokenTypes  = {
  ...
  { Type = 'interface', Style = { Colour= "#ff3db3" } },
