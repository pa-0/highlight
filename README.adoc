...
Highlight was created to provide a versatile yet user-friendly syntax highlighter
for multiple output formats. Instead of hardcoding syntax and colouring information,
all necessary data is saved in configuration scripts. These Lua scripts can be
edited and enhanced with plug-ins.
