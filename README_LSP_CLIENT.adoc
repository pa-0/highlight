...
files'' syntax they process. Most prominent editor is VSCode. A lot of language
servers are designed and tested for this editor, since MS published the LSP
specification and VSCode is the reference. Another well known editors with
LSP support are Kate and Eclipse.
